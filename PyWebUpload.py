...
conn = pyodbc.connect(
    r"DRIVER=SQL Server;" r"SERVER= ;" r"DATABASE= ;" r"Trusted_Connection=yes;"
)
...
def parse_contents(contents, filename, date):
    ...
    if "xls" in filename:
        ...
        for a, b in zip(uploadSheet["Column_1"], uploadSheet["Column_2"]):  # a  # b
            ...
            if ProductionQuery.empty:
                ...
                return html.Div(
                    [
                        html.H5(f"Production Error: Column_1 {str(a)} Not Recognized"),
